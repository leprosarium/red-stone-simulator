    ...
    implements MouseWheelListener
{
    public class ButtonAction extends AbstractAction
    {
        ...
        public int vers;
        final Viewport this$0;

        public ButtonAction(int v)
        {
            this$0 = Viewport.this;
            super();
            vers = v;
        }
    }
    ...
    private void init_setupFrame()
    {
        ...
        frame = new JFrame("Redstone Simulator v2.1");
...
;
    ...
    public void updateTooltip()
    {
        ...
        {
            int p = lyr + i;
            switch($SWITCH_TABLE$com$carneiro$mcredsim$Blocks()[field.g(lastX, lastY, p).ordinal()])
            {
            case 10: // '\n'
            default:
                break;
    ...
    private void updateTitle()
    {
        ...
        if(modified && !IS_MAC)
            m = "*";
        frame.setTitle((new StringBuilder(String.valueOf(m))).append(save == null ? "" : (new StringBuilder(String.valueOf(save.getName()))).append(" - ").toString()).append("Redstone Simulator v2.1").toString());
        if(IS_MAC)
